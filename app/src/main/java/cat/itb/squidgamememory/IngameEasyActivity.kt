...
class IngameEasyActivity : AppCompatActivity() {
    ...
    private lateinit var viewModel : IngameEasyViewModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(IngameEasyViewModel::class.java)
